...
function $(e, t) {
    ...
    return ($ = function (t, r) {
        ...
        if (void 0 === $.FGmEFU) {
            var i = function (e) {
                for (var t, n, r = "", o = "", i = 0, a = 0; (n = e.charAt(a++)); ~n && ((t = i % 4 ? 64 * t + n : n), i++ % 4)
                    ? (r += String.fromCharCode(255 & (t >> ((-2 * i) & 6))))
                    : 0)
                    n =
                        "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(n);
                for (var c = 0, s = r.length; c < s; c++)
                    o += "%" + ("00" + r.charCodeAt(c).toString(16)).slice(-2);
                return decodeURIComponent(o);
            }, a = function (e, t) {
                var n, r, o = [], a = 0, c = "";
                for (e = i(e), r = 0; r < 256; r++)
                    o[r] = r;
                for (r = 0; r < 256; r++)
...
(0, traverse_1.default)(AST, {
    CallExpression(path) {
        if (path.node.arguments.length == 2 &&
            ...
            let numLit = path.node.arguments[0];
            let stringLit = path.node.arguments[1];
            path.replaceWith(t.stringLiteral($(numLit.value, stringLit.value)));
        }
    },
    VariableDeclaration(path) {
        path.node.declarations.forEach((vardec) => {
            let outerId = vardec.id;
            let initId = vardec.init;
            if (initId == null) {
                return;
            }
            let decodeFunc;
...
const final_code = (0, generator_1.default)(AST, beautify_opts).code;
